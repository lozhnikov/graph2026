...
class VertexIterator {
 ...
 public:
   ...
   * @return Возвращает true, если итераторы равны и false в противном случае.
   */
   ...
   * @brief Оператор сравнения != для итератора.
   * @param other Другой итератор.
   * @return Возвращает false, если итераторы равны и true в противном случае.
   */
  bool operator!=(const VertexIterator& other) const {
    return pos != other.pos;
  }
   ...
   * @return Возвращает ссылку на итератор после его инкремента.
   */
   ...
   * @return Возвращает копию итератора до его инкремента.
   */
   ...
   * @return Номер вершины, на которую в данный момент указывает итератор.
   */
...
class VerticesRange {
 ...
 public:
   ...
   * @return Возвращает итератор на первую вершину.
   */
   ...
   * @return Возвращает итератор на вершину "после последней".
   */
