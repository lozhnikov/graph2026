...
class WeightedGraph {
 public:
   ...
   * @return Функция возвращает true, если вершина id есть в графе, в противном
   ...
   * @param id1 Номер первой вершины.
   * @param id2 Номер второй вершины.
   * @return Функция возвращает true, если ребро, соединяющее вершины id1 и id2
   * есть в графе, в противном случае функция возвращает false.
   *
   ...
   *
   * @param id Номер вершины.
   * @return Множество вершин в виде хеш-таблицы, с которыми
   * соединена вершина id.
   *
   ...
   *
   * @param id Номер вершины.
   * @return Множество вершин в виде хеш-таблицы, соединённых
   * с вершиной id.
   *
   ...
   * @param id1 Номер первой вершины.
   * @param id2 Номер второй вершины.
   * @return Функция возвращает вес ребра, соединяющего вершины id1 и id2.
   *
   ...
   * @param id1 Номер первой вершины.
   * @param id2 Номер второй вершины.
   * @return Функция возвращает ссылку на вес ребра, соединяющего
   * вершины id1 и id2.
   *
   ...
   *
   * @return Функция возвращает специальный класс-промежуток, по которому
 ...
 private:
   ...
   * @param id1 Номер первой вершины.
   * @param id2 Номер второй вершины.
   * @return Функция возвращает внутренний идентификатор ребра,
